...
const ethosContent = [
  ...
  `CRAFTSMANSHIP`,
  `NAKACHI NDUMDI products are constructed exclusively from natural fabrics and materials. Production draws on traditions of Indian and European craftsmanship and garment making, which form a central part of the house's manufacturing approach. Garments and objects are produced by skilled tailors and artisans whose work reflects established craft practices. Through ongoing collaboration with these partners, the house seeks to support the continuation of these techniques within a contemporary production context. Production is intentionally limited and closely overseen. Each item is inspected during development and manufacturing by Mr. Sagar and the house's head tailors to ensure that it meets the standards of the house. Clients are encouraged to preserve these items and, where appropriate, pass them on to others.`,
